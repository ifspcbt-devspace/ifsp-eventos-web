            ...
            <div className='space-x-8 flex flex-wrap justify-center mt-16'>
                ...
                <div className='relative w-[17%]'>
                    <div className='h-[285px] w-full'>
                        <Image src="/images/festajunina.jpg" alt='festajunina' quality={100} layout='fill' className='rounded-lg object-cover' />
                    </div>
                ...
                <div className='relative w-[17%]'>
                     <div className='h-[265px] w-full border-2 border-greenxd rounded-lg'>
                        <Image src="/images/festajunina.jpg" alt='festaduvidosa' quality={100} layout='fill' className='rounded-lg object-cover' />
                    </div>
                    <div className='absolute inset-x-0 bottom-0 bg-greenxd h-[100px] rounded-b-[10px]'>
